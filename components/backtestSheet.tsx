      ...
      <SheetContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid gap-4 py-4">
            ...
            {/* Transaction Fee Rate Field */}
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="transaction_fee_rate" className="text-right">
              ...
              <div className="col-span-3 space-y-1">
                <Input
                  ...
                  type="number"
                  step="0.0001"
                  {...register("transaction_fee_rate", {
                    required: "Transaction fee rate is required",
                    valueAsNumber: true,
                    min: { value: 0.000000001, message: "Minimum 0.000000001" }
                  })}
                />
                {errors.transaction_fee_rate && (
                  <p className="text-sm text-red-500">{errors.transaction_fee_rate.message}</p>
                )}
              </div>
            </div>
          </div>
